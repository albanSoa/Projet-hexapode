...
void setup() {
  ...
  // Mise en position 0 (patte orientiées vers le haut)
  servos[0].write(90);
  delay(50);
  servos[1].write(12);
  delay(50);
...
void loop() {
 ...
 if (command == "Avancer") {
      ...
      servos[4].write(150 - 90 + (alpha*180/3.1415)); 
      delay(500);
      ...
      servos[2].write((150 + (beta*180/3.1415))); 
      delay(500);
